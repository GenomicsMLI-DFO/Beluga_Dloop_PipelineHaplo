...
data <- read.table("00_Data/02_dloop_clean/Sequences_Dloop234_n3435.txt", header = T)
str(data)
colnames(data)[2] <- "seq"
...
dna <- fasta2DNAbin("00_Data/01_fasta/Beluga_234bp_n3435.fasta")  # import fasta sequence
...
write.csv(data2, "00_Data/02_dloop_clean/Sequences_Dloop234_n3435.csv", row.names = F)
