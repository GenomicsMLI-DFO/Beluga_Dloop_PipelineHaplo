...
data <- read.table("00_Data/02_dloop_clean/Sequences_Dloop615_n3612.txt", header = T)
str(data)
colnames(data)[2] <- "seq"
...
dna <- fasta2DNAbin("00_Data/01_fasta/Beluga_615bp_n3612.fasta")  # import fasta sequence
...
write.csv(data2, "00_Data/02_dloop_clean/Sequences_Dloop615_n3612.csv", row.names = F)
...
# 
# write.csv(lib_fin, file = paste("02_Results/00_libraries/","librairie_", length(lib_fin$hapl), "_haplotypes615.csv", sep=""), row.names = F)
